...
function ContactPage() {
  ...
  const contactUs = async(e) => {
    ...
    try { 
      ...
      toast.error("please enter email and message", { autoClose: 500, theme: 'colored' })
    }
    else if (!contact.phone) {
      toast.error("Please enter phone number", { autoClose: 500, theme: 'colored' })
    }
    else if (contact.phone) {
      const data = await usePostWithoutRole("/contactus",{name:contact.name,email:contact.email,message:`phone number:${contact.message}\n message${contact.message}`})
      if (data.data.success) {
        toast.success(`${data.data.message}`, { autoClose: 900, theme: 'colored' })
          navigate('/')
        }
  ...
  return (
    ...
    ----------------------------------------------------------*/}
    <svg className='contact-svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none">
      <g id="Image">
        <g id="g14">
          <g id="g16">
            <g id="g22">
    ...
    -------------------------------------------------------------
    ----------------------------------------------------------*/}
    <form className='contect-form' onSubmit={contactUs}>
      ...
      <div className="mb-4 relative">
        ...
        <input
          ...
          id="formName"
          name='name'
          className="form-ctrl-contact form-ctrl-contact-lg thick fix-contact"
          placeholder="Name"
      ...
      <div className="mb-4 message">
        <textarea
          id="formMessage"
          className="form-ctrl-contact form-ctrl-contact-lg fix-contact"
          rows={7}
          name='message'
          placeholder="message"
      ...
      <div className="text-center">
        <button type="submit" className="contact-btn contact-btn-primary fix-contact" tabIndex={-1}>
          Send message
        </button>
      </div>
    </form>
